...
class PasteCreateViewTest(TestCase):
    ...
    def test_create_paste_authenticated(self):
        ...
        response = self.client.post(reverse("voidpaste:index"), {
            "title": "Test Paste",
...
class PasteDetailViewTest(TestCase):
    ...
    def test_paste_detail_view(self):
        response = self.client.get(reverse("voidpaste:paste-detail", kwargs={"link": self.paste.link}))
...
class CommentCreateViewTest(TestCase):
    ...
    def test_create_comment_authenticated(self):
        self.client.login(username="testuser", password="password123")
        response = self.client.post(reverse("voidpaste:add-comment", kwargs={"link": self.paste.link}), {
